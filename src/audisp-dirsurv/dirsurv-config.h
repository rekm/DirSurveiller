 ...
 *
 * Authors:
 *   Rene Kmiecinski <r.w.kmiecinski@gmail.com>
 *   Steve Grubb <sgrubb@redhat.com>
 *
 */

#ifndef AU_DIRSURV_CONFIG_H
#define AU_DIRSURV_CONFIG_H
...
{
    unsigned int use_domain_socket;
    const char *domain_socket;
    unsigned int use_access_validation;
    uid_t target_uid;
    uid_t target_gid;
